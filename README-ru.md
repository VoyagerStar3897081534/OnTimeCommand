...
- 🎣 **Функция Orbital TNT** - Специальная функция удочки, создающая эффекты взрыва TNT
...
#### Конфигурация Orbital TNT (`orbital-tnt-config.yml`)
...
Когда игроки используют специальную удочку с названием "Orbital TNT" для заброса, эффекты взрыва TNT будут
генерироваться в позиции заброса:

1. Генерация центрального TNT в позиции заброса
2. Генерация нескольких колец TNT вокруг центральной точки
3. Каждое кольцо расположено на определенных расстояниях и временных интервалах
4. Создание зрелищных эффектов цепных взрывов
